...
var DEFAULT_APP_SETTINGS = {
  fcm: {
    apiKey: "AAAAr2EVxFU:APA91bFy9_cetgnreaMdPaYJEe_kaLlS8UdmI6E4bM6GzeQoAxBvMXi0n-vb0g2gkbdZcYs128-scn6BQ_LE3flIErm2gk3d0RfVwCIop37zGJ8mDAn7NXSCsTG302P4jCYnrVQypPod",
    ttl: 60,
    priority: "high"
  },
  frd: {
    ...
    case PAYLOAD_TYPES.APP:
      payload.data = {
        app: {
          ...
          message: $("#send-app-message").val(),
          package: $("#send-app-package").val(),
          open: $("#send-app-package-open").is(":checked")
        }
      };
      break;
