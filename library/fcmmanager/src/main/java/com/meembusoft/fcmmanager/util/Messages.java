...
public final class Messages {
    ...
    @NonNull
    public static Messages instance(@NonNull Context context) {
        if (instance == null) {
    ...
    public void add(@NonNull Message<Payload> message) {
    ...
    public void add(@NonNull List<Message<Payload>> messages) {
