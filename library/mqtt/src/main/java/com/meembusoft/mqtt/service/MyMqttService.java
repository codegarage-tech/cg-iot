package com.meembusoft.mqtt.service;
...
import com.meembusoft.mqtt.model.MqttConnection;
import com.meembusoft.mqtt.model.MqttState;
...
public class MyMqttService extends Service {
    ...
    protected void connect(final String serverUri, final String clientId, final String username, final String password) {
        Log.i(TAG, "connect()");
    ...
    protected void updateRecord(String topic, String message) {
        EventBus.getDefault().post(new com.meembusoft.mqtt.model.MqttMessage(topic, message));
    }
