...
public class SlideUp implements View.OnTouchListener, ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener, LoggerNotifier {
    ...
    /**
     * <p>Returns the type of view which will be show in same screen</p>
     */
    public int getSlideUpType() {
        return mBuilder.mSlideUpType;
    }

    /**
     * <p>Set the type of view which will be show in same screen</p>
     *
     * @param slideUpType the slide up type
     */
    public void setSlideUpType(int slideUpType) {
        mBuilder.mSlideUpType = slideUpType;
    }
