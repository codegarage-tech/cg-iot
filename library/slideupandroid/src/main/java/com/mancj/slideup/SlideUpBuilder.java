...
public final class SlideUpBuilder {
    ...
    /**
     * <p>Different types of view for same screen</p>
     *
     * @param slideUpType the tag of the view type.
     */
    public SlideUpBuilder withSlideUpType(@Nullable int slideUpType) {
        mSlideUpType = slideUpType;
        return this;
    }
