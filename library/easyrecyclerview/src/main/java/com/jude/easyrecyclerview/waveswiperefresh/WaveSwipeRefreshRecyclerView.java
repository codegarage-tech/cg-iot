package com.jude.easyrecyclerview.waveswiperefresh;
...
public class WaveSwipeRefreshRecyclerView extends FrameLayout {
    ...
    protected WaveSwipeRefreshLayout mPtrLayout;
    protected WaveSwipeRefreshLayout.OnRefreshListener mRefreshListener;

    public WaveSwipeRefreshLayout getSwipeToRefresh() {
        return mPtrLayout;
    }
    ...
    public WaveSwipeRefreshRecyclerView(Context context) {
        super(context);
        initView();
    }

    public WaveSwipeRefreshRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public WaveSwipeRefreshRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_progress_wave_swipe_refresh_recyclerview, this);
        mPtrLayout = (WaveSwipeRefreshLayout) v.findViewById(R.id.ptr_layout);
        mPtrLayout.setEnabled(false);
        mPtrLayout.setColorSchemeColors(Color.WHITE, Color.WHITE);
        mPtrLayout.setWaveColor(getResources().getColor(R.color.colorPrimaryDark));
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        adapter.registerAdapterDataObserver(new WaveSwipeRefreshLayoutDataObserver(this));
        showRecycler();
    }
     ...
     * @param listener
     */
    public void setRefreshListener(WaveSwipeRefreshLayout.OnRefreshListener listener) {
