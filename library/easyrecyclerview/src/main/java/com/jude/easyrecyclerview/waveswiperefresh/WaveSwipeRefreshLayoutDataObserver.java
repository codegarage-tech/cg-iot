...
public class WaveSwipeRefreshLayoutDataObserver extends RecyclerView.AdapterDataObserver {
    private WaveSwipeRefreshRecyclerView recyclerView;
    private RecyclerArrayAdapter adapter;

    public WaveSwipeRefreshLayoutDataObserver(WaveSwipeRefreshRecyclerView recyclerView) {
