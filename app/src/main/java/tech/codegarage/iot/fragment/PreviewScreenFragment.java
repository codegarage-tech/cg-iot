 ...
 */
public class PreviewScreenFragment extends BaseFragment {

    public static PreviewScreenFragment newInstance() {
        PreviewScreenFragment fragment = new PreviewScreenFragment();
        return fragment;
    }

    @Override
    public int initFragmentLayout() {
        return R.layout.fragment_preview_screen;
    }
