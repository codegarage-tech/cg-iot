package tech.codegarage.iot.geocoding;
...
public class UserLocationAddress implements Parcelable {
    ...
    public UserLocationAddress(double latitude, double longitude, String addressLine, String streetAddress, String city, String state, String country, String countryCode, String postalCode, String knownName) {
