...
public class BluetoothConnector {
    ...
    private String TAG = BluetoothConnector.class.getSimpleName();
        ...
        while (selectSocket()) {
            ...
            try {
                ...
                try {
                    ...
                    Logger.d(TAG, "Could not initialize FallbackBluetoothSocket classes." + e);
                    success = false;
                } catch (InterruptedException e1) {
                    Logger.d(TAG, e1.getMessage() + e1);
                    success = false;
                } catch (IOException e1) {
                    Logger.d(TAG, "Fallback failed. Cancelling." + e1);
                    success = false;
                }
            }
        }
    ...
    private boolean selectSocket() throws IOException {
        ...
        Logger.d(TAG, "Attempting to connect to Protocol: " + uuid);
        if (secure) {
