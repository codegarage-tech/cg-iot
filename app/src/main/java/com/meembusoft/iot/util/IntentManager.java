...
public class IntentManager {
    ...
    public static void shareToAllAvailableApps(Context context, String screenTitle, String shareTitle, String shareText) {
        ...
        if (intentShare.resolveActivity(context.getPackageManager()) != null) {
            context.startActivity(Intent.createChooser(intentShare, screenTitle));
        } else {
