...
public class OrdersActivity extends BaseActivity {
    ...
    public void initActivityViews() {
        ...
        AppUtil.loadImage(getActivity(), ivProduct,"https://i.ebayimg.com/images/g/IPEAAOSwIsdcJfeq/s-l300.jpg", false, false, true);
    }

    @Override
    public void initActivityViewsData(Bundle savedInstanceState) {
        setToolBarTitle(getString(R.string.title_activity_orders));
    }
