 ...
 */
public class LoginViaQRCodeActivity extends BaseActivity {
    ...
    public int initActivityLayout() {
        return R.layout.activity_login_via_qr_code;
    }
    ...
    public void initActivityViewsData(Bundle savedInstanceState) {
        setToolBarTitle(getString(R.string.title_activity_login_via_qr_code));
    }
